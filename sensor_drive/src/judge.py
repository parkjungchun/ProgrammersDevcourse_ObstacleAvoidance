...
class judge:
    ...
    modified_speed_for_mapping = 10

    drive_mode = [
        [ { "angle": 0,  "speed":  30//modified_speed_for_mapping, "time":  float('inf') }                                                     ],
        [ { "angle": 0,  "speed": -25//modified_speed_for_mapping, "time":  2            }, { "angle": 50, "speed": 30//modified_speed_for_mapping, "time": 2            } ],
        [ { "angle": 0,  "speed":   0, "time":  float('inf') }                                                     ],
        [ { "angle": 50, "speed": -25//modified_speed_for_mapping, "time":  2            }, { "angle": 0, "speed": 30//modified_speed_for_mapping, "time": 2             } ],
        [ { "angle": 0,  "speed":  30//modified_speed_for_mapping, "time":  float('inf') }                                                     ]
    ]
    ...
    def mode_and_action_checker(self, obstacle):
        ...
        if current_speed != 0:
            speed_state = self.speed_states[int(current_speed/abs(current_speed))]
        else:
    ...
    def set_default_angle(self, angle):
        self.drive_mode[default][0]["angle"] = angle
